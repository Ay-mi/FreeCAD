...
__title__ = "MbDFEM Command Create Bill of Materials"
__author__ = "Ondsel"
...
TranslatedColumnNames = [
    translate("MbDFEM", "Index (auto)"),
    translate("MbDFEM", "Name (auto)"),
    translate("MbDFEM", "Description"),
    translate("MbDFEM", "File Name (auto)"),
    translate("MbDFEM", "Quantity (auto)"),
]
...
class CommandCreateBom:
    ...
    def GetResources(self):
        return {
            "Pixmap": "MbDFEM_BillOfMaterials",
            "MenuText": QT_TRANSLATE_NOOP("MbDFEM_CreateBom", "Bill of Materials"),
            "Accel": "O",
            "ToolTip": QT_TRANSLATE_NOOP(
                "MbDFEM_CreateBom",
                "<p>Creates a bill of materials of the current MbDFEM. If an MbDFEM is active, it will be a BOM of this MbDFEM. Else it will be a BOM of the whole document.</p>"
    ...
    def Activated(self):
        self.panel = TaskMbDFEMCreateBom()
...
class TaskMbDFEMCreateBom(QtCore.QObject):
    def __init__(self, bomObj=None):
        super().__init__()

        self.form = Gui.PySideUic.loadUi(":/panels/TaskMbDFEMCreateBom.ui")
    ...
    def addColumn(self):
        new_name = translate("MbDFEM", "Default")
    ...
    def itemUpdated(self, item):
        ...
        if duplicate_found:
            QtWidgets.QMessageBox.warning(
                self.form,
                translate("MbDFEM", "Duplicate Name"),
                translate("MbDFEM", "This name is already used. Please choose a different name."),
            )
    ...
    def createBomObject(self):
        ...
        if MbDFEM is not None:
            ...
            commands = 'bomObj = App.activeDocument().addObject("MbDFEM::BomObject", "Bill of Materials")'
    ...
    def showHelpDialog(self):
        ...
        options_title = QtWidgets.QLabel("<b>" + translate("MbDFEM", "Options") + "</b>")
        options_text = QtWidgets.QLabel(
            " - "
            + translate(
                "MbDFEM",
                "Sub-MbDFEM children: the children of sub-assemblies will be included in the bill of materials",
            )
            + "\n"
            " - "
            + translate(
        ...
        columns_title = QtWidgets.QLabel("<b>" + translate("MbDFEM", "Columns") + "</b>")
        ...
        export_title = QtWidgets.QLabel("<b>" + translate("MbDFEM", "Export") + "</b>")
...
if App.GuiUp:
    Gui.addCommand("MbDFEM_CreateBom", CommandCreateBom())
