...
def preferences():
    return FreeCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/MbDFEM")


class PreferencesPage:
    def __init__(self, parent=None):
        self.form = FreeCADGui.PySideUic.loadUi(":preferences/MbDFEM.ui")
    ...
    def loadSettings(self):
        ...
        self.form.groundFirstPart.addItem(translate("MbDFEM", "Ask"))
        self.form.groundFirstPart.addItem(translate("MbDFEM", "Always"))
        self.form.groundFirstPart.addItem(translate("MbDFEM", "Never"))
