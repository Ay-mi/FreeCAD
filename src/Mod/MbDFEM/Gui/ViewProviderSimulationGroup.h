...
class MbDFEMGuiExport ViewProviderSimulationGroup: public Gui::ViewProviderDocumentObjectGroup
{
    PROPERTY_HEADER_WITH_OVERRIDE(MbDFEMGui::ViewProviderSimulationGroup);
