...
class MbDFEMExport BomObject: public Spreadsheet::Sheet
{
    PROPERTY_HEADER_WITH_OVERRIDE(MbDFEM::BomObject);
...
public:
    ...
    {
        return "MbDFEMGui::ViewProviderBom";
    }
