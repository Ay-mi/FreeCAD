...
class MbDAssembly(Part):
    ...
    def solve(self, enableUndo: bool = False, /) -> int:
        """
        Solve the MbDFEM and update part placements.
    ...
    def updateForFrame(self, index: int, /) -> None:
        """
        Update entire MbDFEM to frame number specified.
    ...
    def undoSolve(self) -> Any:
        """Undo the last solve of the MbDFEM and return part placements to their initial position.
    ...
    def exportAsASMT(self, file_name: str, /) -> None:
        """
        Export the MbDFEM in a text format called ASMT.
    ...
    def getDownstreamParts(
        ...
        ...
    Joints: Final[list]
    """A list of all joints this MbDFEM has."""
