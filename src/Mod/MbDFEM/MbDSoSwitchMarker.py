...
__title__ = "MbDFEM Marker Inventor object"
...
class MbDSoSwitchMarker(coin.SoSwitch):
    def __init__(self, vobj):
        ...
        self.x_axis_so_color.rgb.setValue(UtilsMbDFEM.color_from_unsigned(param_x_axis_color))
        self.y_axis_so_color = coin.SoBaseColor()
        self.y_axis_so_color.rgb.setValue(UtilsMbDFEM.color_from_unsigned(param_y_axis_color))
        self.z_axis_so_color = coin.SoBaseColor()
        self.z_axis_so_color.rgb.setValue(UtilsMbDFEM.color_from_unsigned(param_z_axis_color))
